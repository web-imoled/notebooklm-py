...
- Integration total: 624
- Integration `vcr and not allow_no_vcr`: 153
- Integration `allow_no_vcr and not vcr`: 470
...
471 node IDs. See `tests/_fixtures/integration_allow_no_vcr_nodeids.txt` for the exact baseline.
